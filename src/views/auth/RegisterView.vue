        ...
        <form @submit.prevent="handleRegister" novalidate>
          ...
          <div class="row-2">
            <div class="field" :class="{ 'field--error': errors.name }">
              ...
              <div class="input-wrap">
                ...
                <input v-model="form.name" type="text" class="input" placeholder="Carlos" autocomplete="given-name"
                  @input="errors.name = ''" />
              </div>
            ...
            <div class="field" :class="{ 'field--error': errors.lastname }">
              ...
              <div class="input-wrap">
                ...
                <input v-model="form.lastname" type="text" class="input" placeholder="Díaz" autocomplete="family-name"
          ...
          <div class="field" :class="{ 'field--error': errors.password }">
            ...
            <div class="input-wrap">
              ...
              <input v-model="form.password" :type="showPass ? 'text' : 'password'" class="input"
                placeholder="Mínimo 8 caracteres" autocomplete="new-password" @input="errors.password = ''" />
          ...
          <div class="field" :class="{ 'field--error': errors.password2 }">
            ...
            <div class="input-wrap">
              ...
              <input v-model="form.password2" type="password" class="input" placeholder="Repite tu contraseña"
                autocomplete="new-password" @input="errors.password2 = ''" />
            </div>
...
.bg-orb--3 {
  width: 300px;
  height: 300px;
  background: radial-gradient(circle, rgba(0, 86, 255, 0.1), transparent 70%);
  top: 40%;
  left: 60%;
...
.bg-lines {
  ...
  inset: 0;
  pointer-events: none;
  background-image: linear-gradient(rgba(0, 86, 255, 0.035) 1px, transparent 1px), linear-gradient(90deg, rgba(0, 86, 255, 0.035) 1px, transparent 1px);
...
.btn-primary {
  ...
  box-shadow: 0 4px 18px rgba(0, 86, 255, 0.32);
  min-height: 48px;
}
