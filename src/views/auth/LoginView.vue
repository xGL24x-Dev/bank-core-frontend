        ...
        <form @submit.prevent="handleLogin" novalidate>
          ...
          <div class="field" :class="{ 'field--error': errors.password }">
            ...
            <div class="input-wrap">
              ...
              <input v-model="form.password" :type="show ? 'text' : 'password'" class="input" placeholder="••••••••"
                autocomplete="current-password" @input="errors.password = ''; authStore.clearError()" />
              <button type="button" class="eye" @click="show = !show" tabindex="-1">
                <svg v-if="!show" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
